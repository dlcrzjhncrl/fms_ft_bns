...
Add New Facility via Amendment Notebook
    ...
    ...    @update: mduran    08NOV2021    - BNS Custom Changes: added Facility_SubType parameter, MIS Code 
    ...
    Populate Facility Select Window - Amendment Notebook    ${ExcelPath}[Deal_Name]    ${ExcelPath}[Facility_Name]    ${Excelpath}[Facility_Type]    ${Excelpath}[Facility_Currency]    ${ExcelPath}[Facility_SubType]        
    ...
    Populate the Fields in Facility Notebook - Summary Tab    ${ExcelPath}[MSG_Customer]    ${ExcelPath}[Facility_AgreementDate]    ${ExcelPath}[Facility_ExpiryDate]    ${ExcelPath}[Facility_MaturityDate]
