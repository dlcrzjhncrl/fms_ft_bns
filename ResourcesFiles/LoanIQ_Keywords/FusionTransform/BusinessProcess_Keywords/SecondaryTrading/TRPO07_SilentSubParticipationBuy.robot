...
*** Keywords ***
Setup Silent Sub Participation Buy
    [Documentation]    This keyword is used to setup silent sub participation buy in circle select
    ...    @author: mnanquilada    31AUG2021    - initial create
    [Arguments]    ${ExcelPath}
    
    Report Sub Header    Secondary Trading - Silent Sub Participation Buy
    ...
    Write Data To Excel    TRPO07_SilentParticipationBuy    Pct_Of_Deal    ${ExcelPath}[rowid]    ${pctOfDeal}