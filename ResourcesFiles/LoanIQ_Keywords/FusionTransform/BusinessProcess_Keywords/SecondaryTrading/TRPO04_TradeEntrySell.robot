...
*** Keywords ***
Setup Trade Entry Sell
    [Documentation]    This keyword is used to setup trade entry sell
    ...    @author: mnanquilada    23AUG2021    - initial create
    [Arguments]    ${ExcelPath}
    
    Report Sub Header    Secondary Trading - Trade Entry Sell
    ...
    Setup Porfolio Facility Detail Long Amount   ${ExcelPath}[Facility_Name]    ${ExcelPath}[Portfolio]    ${ExcelPath}[Portfolio_Expense_Code]
