...
LIQ_OpenAUserProfile_Cancel_Button = 'JavaWindow("title:=Open A User Profile.*").JavaButton("label:=Cancel")'
...
LIQ_PhoneFax_PhoneNum_Textfield = 'JavaWindow("title:=Phone.*Fax for.*").JavaEdit("attached text:=Phone Number.*")'
...
### Events ###
LIQ_UserProfile_Tab = 'JavaWindow("title:=User Profile Maintenance.*").JavaTab("tagname:=TabFolder")'
LIQ_UserProfile_UserLoginID = 'JavaWindow("title:=User Profile Maintenance.*").JavaEdit("attached text:=User Login ID.*")'
LIQ_UserProfile_UserLocked = 'JavaWindow("title:=User Profile Maintenance.*").JavaCheckBox("attached text:=User Locked")'
LIQ_UserProfile_JavaTree = 'JavaWindow("title:=User Profile Maintenance.*").JavaTree("attached text:=Select event to view details.*")' 
