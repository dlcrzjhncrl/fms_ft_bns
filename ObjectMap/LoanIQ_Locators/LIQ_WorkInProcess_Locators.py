...
LIQ_TransactionInProcess_Outstandings_List_ForMassDeal='JavaWindow("title:=Transactions In Process.*").JavaTree("attached text:=0")'
...
LIQ_WorkInProgress_TransactionDealsStatus_List = 'JavaWindow("title:=Transactions In Process.*").JavaTree("attached text:=0")'
...
LIQ_ScheduledActivityReport_List = 'JavaWindow("title:=Scheduled Activity Report.*").JavaTree("displayed:=1")'
LIQ_ScheduledActivityReport_Exit_Button = 'JavaWindow("title:=Scheduled Activity Report.*").JavaButton("attached text:=Exit")'
...
### Circles ###
LIQ_TransactionsInProcess_Circles_Tree = 'JavaWindow("title:=Transactions In Process.*").JavaTab("tagname:=TabFolder","value:=Circles").JavaTree("tagname:=0")'