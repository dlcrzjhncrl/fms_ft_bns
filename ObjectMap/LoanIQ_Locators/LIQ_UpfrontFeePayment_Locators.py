...
LIQ_UpfrontFeePayment_Notebook = 'JavaWindow("title:=.*Fee Payment from Borrower / Agent / Third Party - .*","displayed:=1")'
...
LIQ_UpfrontFeeAmount_Textfield= 'JavaWindow("label:=.*Upfront Fee Payment from Borrower / Agent / Third Party -.*","displayed:=1").JavaEdit("attached text:=Amount:")'
LIQ_FeeDetail_Button= 'JavaWindow("label:=.*Fee Payment from Borrower / Agent / Third Party -.*","displayed:=1").JavaButton("attached text:=Fee Detail")'
LIQ_UpfrontFee_Comment_Textfield= 'JavaWindow("label:=.*Upfront Fee Payment from Borrower / Agent / Third Party -.*").JavaEdit("labeled_containers_path:=Tab:General;Group:Comment;","index:=1")'
LIQ_UpfrontFee_EffectiveDate_Textfield= 'JavaWindow("label:=.*Upfront Fee Payment from Borrower / Agent / Third Party -.*","displayed:=1").JavaEdit("attached text:=Effective Date:")'
LIQ_UpfrontFee_Branch_Dropdown= 'JavaWindow("label:=.*Upfront Fee Payment from Borrower / Agent / Third Party -.*","displayed:=1").JavaList("attached text:=Branch:")'
LIQ_UpfrontFee_Currency_Dropdown= 'JavaWindow("label:=.*Upfront Fee Payment from Borrower / Agent / Third Party -.*","displayed:=1").JavaList("attached text:=Currency:")'
...
LIQ_FeeDetail_FeeAmount_TextField = 'JavaWindow("title:=Fee Detail","displayed:=1").JavaEdit("attached text:=Amount:")'
...
### Upfront Fee VAT Values ###
LIQ_UpfrontFee_VAT_Window = 'JavaWindow("title:=Choose a VAT set of values")'
LIQ_UpfrontFee_VAT_Original_Button = 'JavaWindow("title:=Choose a VAT set of values").JavaButton("attached text:=Original")'
LIQ_UpfrontFee_VAT_Current_Button = 'JavaWindow("title:=Choose a VAT set of values").JavaButton("attached text:=Current")'