...
LIQ_TickingFeeNotebook_EffectiveDate_TextField = 'JavaWindow("title:=Ticking Fee.*").JavaEdit("attached text:=Effective Date:")'
...
LIQ_TickingFeeNotebook_Currency_Dropdown = 'JavaWindow("title:=Ticking Fee.*").JavaList("attached text:=Currency:")'
LIQ_TickingFeeNotebook_CashflowFromBorrower_RadioButton = 'JavaWindow("title:=Ticking Fee.*").JavaRadioButton("attached text:=From Borrower/Third Party")'
LIQ_TickingFeeNotebook_CashflowFromAgent_RadioButton = 'JavaWindow("title:=Ticking Fee.*").JavaRadioButton("attached text:=From Agent")'
LIQ_TickingFeeNotebook_AmountPaidToDate_Text = 'JavaWindow("title:=Ticking Fee.*").JavaEdit("attached text:=Amount Paid To Date:")'
LIQ_TickingFeeNotebook_CurrentBalance_Text = 'JavaWindow("title:=Ticking Fee.*").JavaEdit("attached text:=Current Balance:")'
LIQ_TickingFeeNotebook_ActualAmount_Text = 'JavaWindow("title:=Ticking Fee.*").JavaEdit("attached text:=Actual Amount:")'
LIQ_TickingFeeNotebook_WaivedAmount_Text = 'JavaWindow("title:=Ticking Fee.*").JavaEdit("attached text:=Waived Amount:")'
