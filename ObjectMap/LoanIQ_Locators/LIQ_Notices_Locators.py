...
LIQ_Notice_Text_Textarea = 'JavaWindow("title:=.* created by .*","displayed:=1", "index:=1").JavaEdit("index:=1")'
...
LIQ_Notice_DrawdownIntent_Notice_Exit_Button = 'JavaWindow("title:=Drawdown Intent Notice.*").JavaButton("attached text:=Exit")'
LIQ_NoticeGroup_Send_Button = 'JavaWindow("title:=.* Group created by .*","displayed:=1").JavaButton("attached text:=Send")'
...
### Notices Group Window ###
LIQ_NoticesGroup_Window = 'JavaWindow("title:=.* Notices Group created by .*","displayed:=1")'
LIQ_NoticesGroup_Items_JavaTree = 'JavaWindow("title:=.* Notices Group created by .*","displayed:=1").JavaTree("attached text:=Drill down to mark notices")'
LIQ_NoticesGroup_Refresh_Button = 'JavaWindow("title:=.* Notices Group created by .*","displayed:=1").JavaButton("attached text:=Refresh")'
LIQ_NoticesGroup_Unmarkall_Button = 'JavaWindow("title:=.* Notices Group created by .*","displayed:=1").JavaButton("attached text:=Unmark all")'
LIQ_NoticesGroup_EditHighlightNotices = 'JavaWindow("title:=.* Notices Group created by .*","displayed:=1").JavaButton("attached text:=Edit Highlighted Notices")'
LIQ_NoticesGroup_Exit_Button = 'JavaWindow("title:=.* created by .*","displayed:=1").JavaButton("label:=Exit")'
LIQ_Notices_Text_Textarea = 'JavaWindow("title:=.* Notices created by .*","displayed:=1").JavaEdit("index:=1")'
LIQ_NoticesCreatedBy_File_Exit = 'JavaWindow("title:=.* Notices created by .*","displayed:=1").JavaMenu("label:=File").JavaMenu("label:=Exit")'