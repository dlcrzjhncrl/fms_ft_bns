...
LIQ_ExchangeRate_Fundingdesk_Label = 'JavaWindow("title:=Please Enter Currency.*").JavaStaticText("text:=${LIQ_FundingDeskCurrency}")'
...
LIQ_ExchangeRate_Currency_Label = 'JavaWindow("title:=Please Enter Currency.*").JavaStaticText("text:=${LIQ_Currency}")'
...
LIQ_ExchangeRate_Rate_Textfield = 'JavaWindow("title:=Please Enter Currency.*").JavaEdit("attached text:=${LIQ_Rate}")'
...
LIQ_ExchangeRate_OK_Button = 'JavaWindow("title:=Please Enter Currency.*").JavaButton("label:=OK")'
...
LIQ_CurrencyExchangeRate_Event_FundingDesk_Label = 'JavaWindow("title:=Currency Exchange Rate.*Event.*").JavaStaticText("label:=${LIQ_FundingDesk}")'
LIQ_CurrencyExchangeRate_Event_FundingDesk_Currency_Label = 'JavaWindow("title:=Currency Exchange Rate.*Event.*").JavaStaticText("label:=${LIQ_FundingDeskCurrency}")'
LIQ_CurrencyExchangeRate_Event_Currency_Label = 'JavaWindow("title:=Currency Exchange Rate.*Event.*").JavaStaticText("label:=${LIQ_Currency}")'
LIQ_CurrencyExchangeRate_Event_Rate_Label = 'JavaWindow("title:=Currency Exchange Rate.*Event.*").JavaStaticText("label:=${LIQ_Rate}")'