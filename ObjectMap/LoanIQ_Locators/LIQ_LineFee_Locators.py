...
LIQ_LineFee_Cycles_OK_Button = 'JavaWindow("title:=Cycles for Line Fee.*").JavaButton("label:=OK")'
LIQ_LineFee_Cycles_Cancel_Button = 'JavaWindow("title:=Cycles for Line Fee.*")JavaButton("label:=Cancel")'