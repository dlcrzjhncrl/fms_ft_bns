...
LIQ_ScheduledPrincipalPayment_AutoReduceFacility_Checkbox = 'JavaWindow("title:=.*Scheduled Principal Payment.*").JavaCheckBox("attached text:=Auto-Reduce Facility")'
