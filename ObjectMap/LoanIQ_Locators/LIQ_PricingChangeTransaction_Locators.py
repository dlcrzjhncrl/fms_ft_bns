...
LIQ_PricingChangeTransaction_Option_CopyFeePricing = 'JavaWindow("title:=.*Pricing Change Transaction.*").JavaMenu("label:=Options").JavaMenu("label:=Copy Fee Pricing")'
LIQ_PricingChangeTransaction_Option_CopyInterestPricing = 'JavaWindow("title:=.*Pricing Change Transaction.*").JavaMenu("label:=Options").JavaMenu("label:=Copy Interest Pricing")'
...
LIQ_Pricing_OngoingFees_AddItem_Window = 'JavaWindow("title:=Add Item")'
...
LIQ_PricingChangeTransaction_FeeSelection_OK_Button = 'JavaWindow("title:=Fee Selection").JavaButton("attached text:=OK")'
...
LIQ_PricingChangeTransaction_OngoingFeePricingWindow_FacilityOngoingFee_Item = 'JavaWindow("title:=.*Ongoing Fee Pricing").JavaTree("tagname:=Tree", "developer name:=.*${OngoingFee_Category}.*")'
...
LIQ_PricingChangeTransaction_OngoingFeePricingWindow_Validate_Button = 'JavaWindow("title:=.*Ongoing Fee Pricing").JavaButton("label:=Validate")' 
...
### Pricing Change Transaction - Copy Ongoing Fee Pricing Window ###
LIQ_PricingChangeTransaction_CopyOngoingFeePricing_Window = 'JavaWindow("title:=Copy Ongoing Fee.*")'
LIQ_PricingChangeTransaction_CopyOngoingFeePricing_OK_Button = 'JavaWindow("title:=Copy Ongoing Fee.*").JavaButton("attached text:=OK")'

### Pricing Change Transaction - Copy Interest Pricing Window ###
LIQ_PricingChangeTransaction_CopyInterestFeePricing_Window = 'JavaWindow("title:=Copy Interest Pricing.*")'
LIQ_PricingChangeTransaction_CopyInterestFeePricing_OK_Button = 'JavaWindow("title:=Copy Interest Pricing.*").JavaButton("attached text:=OK")'